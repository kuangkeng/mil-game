...
function makeSc(btnTitle, scLast) {
  ...
  function makeBtn() {
    ...
    } else if (scData[0].optNum == 2) {
      $('#scOption-' + btnTitle).append('<div class="row"><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target0 +'">'+ scData[0].opt0 +'</button></div><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target1 +'">'+ scData[0].opt1 +'</button></div><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target2 +'">'+ scData[0].opt2 +'</button></div></div>');
    } else {
      $('#scOption-' + btnTitle).append('<div class="row"><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target0 +'">'+ scData[0].opt0 +'</button></div><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target1 +'">'+ scData[0].opt1 +'</button></div><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target2 +'">'+ scData[0].opt2 +'</button></div><div class="col" style="padding-left:5px; padding-right:5px;"><button type="button" class="btn btn-light btn-sm btnOpt" data-id="'+ scData[0].target3 +'">'+ scData[0].opt3 +'</button></div></div>');
    }
  }
